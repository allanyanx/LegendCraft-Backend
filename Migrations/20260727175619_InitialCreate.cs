    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleHighlights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticleHighlights_Articles_ArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleAttributes", x => new { x.ArticleId, x.AttributeValueId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleAttributes_AttributeValues_AttributeValueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleAttributes_AttributeValueId",
                table: "ArticleAttributes",
                column: "AttributeValueId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleHighlights_ArticleId",
                table: "ArticleHighlights",
                column: "ArticleId");
